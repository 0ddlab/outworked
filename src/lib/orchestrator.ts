...
- To share the site with someone externally, the agent should use the tunnel_start tool to get a public URL, then use send_message to share the link via Discord, Slack, or another configured messaging channel.
