  ...
  return (
    <div className=" border-b border-gray-800">
      ...
      <button
        ...
        className="w-full h-full px-2 py-1.5 flex items-center gap-1.5 text-left hover:bg-slate-800/50 transition-colors cursor-pointer"
      >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700">
              ...
              <button
                onClick={() => setShowModal(false)}
                className="text-slate-400 hover:text-white text-xs font-pixel px-1 cursor-pointer"
              >
                X
              </button>
            </div>
